        ...
        <div className="overflow-y-auto flex-1 p-6">
          <div className="space-y-6">
            ...
            {project.additionalRequests && (
              <div>
                <h3 className="text-lg font-medium text-gray-900">Additional Requirements</h3>
                <p className="mt-2 text-gray-600 whitespace-pre-wrap">{project.additionalRequests}</p>
              </div>
            )}
