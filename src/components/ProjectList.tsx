...
export default function ProjectList() {
  ...
  if (error) {
    return (
      <div className="card border-0 shadow-lg bg-gradient-to-r from-red-50 to-rose-50 p-8 my-6">
  ...
  if (projects.length === 0) {
    return (
      <div className="card flex flex-col items-center text-center py-16 px-8 bg-white/80 backdrop-blur-md border-dashed border-2 border-gray-200">
        ...
        <a 
          href="/submit"
          className="btn animate-pulse-slow"
        >
