  ...
  return (
    <nav className="card backdrop-blur-xl shadow-lg mx-4 mt-6 mb-4 sm:mx-6 md:mx-8 border border-white/20 relative z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden animate-fadeIn shadow-lg border-t border-gray-100 dark:border-gray-800" id="mobile-menu">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              {session?.user?.isAdmin && (
                <Link
                  href="/admin"
                  className="mobile-nav-link block px-3 py-2 my-1 rounded-md text-base font-medium text-indigo-600 hover:text-indigo-800 hover:bg-indigo-50 transition-colors active:bg-indigo-100 active:scale-95 transform"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  <div className="flex items-center">
            ...
            <div className="pt-4 pb-3 border-t border-gray-200 dark:border-gray-700">
              {!loading && !session && (
                <div className="px-4">
                  <button
                    ...
                    className="w-full flex items-center justify-center py-2.5 px-4 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700 text-sm font-medium transition-colors"
                  >
                    <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M11.5 2C6.81 2 3 5.81 3 10.5c0 4.69 3.81 8.5 8.5 8.5 4.69 0 8.5-3.81 8.5-8.5C20 5.81 16.19 2 11.5 2zm0 3c1.93 0 3.5 1.57 3.5 3.5S13.43 12 11.5 12 8 10.43 8 8.5 9.57 5 11.5 5zm0 13.25c-2.77 0-5.22-1.41-6.66-3.56.03-2.03 4.45-3.14 6.66-3.14 2.2 0 6.63 1.11 6.66 3.14-1.44 2.15-3.9 3.56-6.66 3.56z" fill="currentColor"/>
                    </svg>
              ...
              {!loading && session && (
                <div className="px-4 space-y-3">
                  <div className="flex items-center px-4 py-2 rounded-lg bg-white/40 dark:bg-gray-800/40 border border-white/30 dark:border-gray-700/30 shadow-sm">
                    {session.user.image && (
                      <Image
                        className="h-8 w-8 rounded-full ring-2 ring-white/50 dark:ring-gray-700/50 mr-3"
                        src={session.user.image}
                        alt={session.user.name || 'User'}
                        width={32}
                        height={32}
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center py-2 px-4 rounded-lg text-indigo-600 bg-indigo-50 hover:bg-indigo-100 border border-indigo-100 text-sm font-medium transition-colors"
                  >
                    <svg className="w-4 h-4 mr-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M16 17L21 12L16 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      <path d="M21 12H9" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
