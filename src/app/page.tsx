...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-5xl mx-auto py-12 px-4 sm:px-8 lg:px-16">
        ...
        <section className="relative flex flex-col items-center justify-center mb-24 pt-10 min-h-[420px]">
          ...
          <div className="relative z-10 w-full flex flex-col items-center">
            <div className="card px-8 py-12 max-w-3xl mx-auto flex flex-col items-center gap-6 backdrop-blur-xl">
              ...
              <p className="mt-6 text-xl md:text-2xl text-gray-700 dark:text-slate-200 font-medium text-center max-w-2xl">
                Do the Math with AI — Explore and submit project ideas for our company hackathon
              </p>
              
              <Link href="/submit" className="btn mt-4 group">
        ...
        <section className="mb-20">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-6 mb-12">
            <div className="relative">
              <h2 className="text-3xl sm:text-4xl font-bold tracking-tight dark:text-white">Project Ideas</h2>
              <p className="mt-3 text-gray-600 dark:text-slate-300">Browse the innovative concepts from our talented team</p>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex flex-col items-center md:items-start gap-2">
              <div className="flex items-center gap-3">
                <Image
                  ...
                  priority
                />
                <span className="text-xl text-gray-600 dark:text-slate-200 font-medium">Do the Math</span>
              </div>
              <p className="text-gray-500 dark:text-slate-300 text-sm mt-2 max-w-md text-center md:text-left">
            ...
            <div className="flex flex-col items-center md:items-end gap-2">
              <div className="flex space-x-4">
                <a href="#" className="text-gray-500 hover:text-gray-700 dark:text-slate-400 dark:hover:text-slate-200 transition-colors">
